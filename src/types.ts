...
/** Whether this call is to the owner/user or to a third party. */
export type CallParty = "first-party" | "third-party";
...
export type OutboundCallOptions = {
  ...
  mode?: CallMode;
  /** Optional talking points to guide the conversation */
